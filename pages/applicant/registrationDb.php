...
<body>
    <div class="container-fluid">
        ...
        <div class="tablez">
            ...
            <table>
                <div class="row border-0">
                    <td class="paalala" rowspan="6" colspan="6">(Student's Copy)<br />
                        <p class="text-danger"> MGA PAALALA: </p>
                        <p>1. Filipino, may asawa o wala at kailangang naninirahan sa Lungsod ng San Jose Del Monte sa loob ng tatlo (3) o mahigit pang taon, nakapagtapos ng sekondarya sa alin mang paaralan sa Lungsod, pribado man o pampubliko. Kung hindi naman nakapagtapos sa Lungsod ay kinakailangang residente nito sa nakalipas na limang (5) taon. <br /></p>
                        <p>2. Hindi lalagpas ng 30 taon ang edad sa araw ng paghahain ng aplikasyon.<br />
                        <p>
