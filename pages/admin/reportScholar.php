...
<body>
    <section id="content" class="home-section">
        <nav class="navbar navbar-light bg-light d-flex mt-5">
            <h3 class="scholarList ms-5">Scholar List</h3>
        ...
        <script>
            ...
            function refreshTable(searchQuery = "") {
                ...
                xhttp.open("GET", "action/reportScholarList.php?page=" + currentPage + "&searchQuery=" + searchQuery, true);
                xhttp.send();
            }
    ...
    function printTable() {
        ...
        printWindow.document.write('<h2>Scholar List</h2> <style> h2 {text-align: center; margin-bottom: 20px;}</style>');
