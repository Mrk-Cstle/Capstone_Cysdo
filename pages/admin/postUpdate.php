            ...
            <div class="tab-content">
                <div class="tab-pane active" id="scholar">
                    ...
                    <div id="scholarAnnouncementsContainer">
                        ...
                        <?php
                        $scholarAnnouncements = mysqli_query($conn, "SELECT * FROM announcements WHERE category = 'scholar' ORDER BY uploadId DESC");
                ...
                <div class="tab-pane" id="applicant">
                    ...
                    <div id="applicantAnnouncementsContainer">
                        ...
                        <?php
                        $applicantAnnouncements = mysqli_query($conn, "SELECT * FROM announcements WHERE category = 'applicant' ORDER BY uploadId DESC");
