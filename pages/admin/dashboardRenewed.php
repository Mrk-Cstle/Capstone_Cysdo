...
<body>
    <section id="content" class="home-section">
        <nav class="navbar navbar-light bg-light d-flex mt-5">
            <h3 class="scholarList ms-5">Renewed Scholar List</h3>
        ...
        <script>
            ...
            function addData() {
                ...
                xhttp.open("GET", "action/dashboardRenewedList.php", true);
                xhttp.send();
            }
            ...
            function refreshTable(searchQuery = "") {
                ...
                xhttp.open("GET", "action/dashboardRenewedList.php?page=" + currentPage + "&searchQuery=" + searchQuery, true);
                xhttp.send();
            }
            ...
            function loadPage(page) {
                ...
                xhttp.open("GET", "action/dashboardRenewedList.php?page=" + page + "&searchQuery=" + searchQuery, true);
                xhttp.send();
            }
    ...
    function printTable() {
        ...
        printWindow.document.write('<h2>Renewed Scholar List</h2> <style> h2 {text-align: center; margin-bottom: 20px;}</style>');
