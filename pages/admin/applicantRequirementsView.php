            ...
            <div class="portlet light">
                ...
                <div class="portlet-title tabbable-line">
                    <div class="caption caption-md">
                        ...
                        <a class="resetPassword btn btn-sm btn-success" onclick="sendAction('<?php echo $examination_id ?>', 'approve')">Approve to Scholar</a>
                        <a class="resetPassword btn btn-sm btn-danger" onclick="sendAction('<?php echo $examination_id ?>', 'denied')">Failed Requirements</a>
                    </div>
                        ...
                        <form id="applicantForm" class="renewal-form" role="form" autocomplete="off" enctype="multipart/form-data">
                            <div class="portletForm light bg-inverse">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <button style="margin-left: 60%;" class="btnUpdate-peronalInfo btn btn-success btn-sm" onclick="sendAction('<?php echo $applicant_id ?>','applicantForm')">Submit</button>
                                </div>
                            </div>
                    </div>
                </div>
