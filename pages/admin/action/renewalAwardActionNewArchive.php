...
if (isset($_POST['id']) && isset($_POST['action'])) {
    ...
    $sql = "SELECT scholar.*,newscholar_award_archive.*
        FROM newscholar_award_archive
        JOIN scholar ON scholar.scholar_id = newscholar_award_archive.scholar_id
       
        WHERE newscholar_award_archive.scholar_release_id = '$applicantId'";
...
function approve($row)
{
    ...
    $applicantId = $_POST['id'];
    $scholar_release_id = $row['scholar_release_id'];
    $newrelease_status = '';
    $date = $row['date'];
    ...
    try {
        $insertQuery = "INSERT INTO `newscholar_award`(`scholar_release_id`, `scholar_id`, `newrelease_status`, `date`) VALUES ('$scholar_release_id', '$scholar_id', '$newrelease_status', '$date')";
        ...
        mysqli_query($conn, "DELETE FROM newscholar_award_archive WHERE scholar_release_id =  '$applicantId'");
