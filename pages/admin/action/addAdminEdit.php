...
try {
    ...
    if (
        ...
        && $row['contact_number'] === $contactNum && $row['email'] === $email
    ) {
        // No changes were made
        echo 'No changes were made';
    } else {
        // Changes were made, execute the UPDATE query
        mysqli_query($conn, "UPDATE admin SET full_name = '$fullName', last_name='$lName', first_name='$fName', middle_name = '$mName',  contact_number= '$contactNum', email = '$email', password = '$hashedPassword'  WHERE admin_id = '$id'");
