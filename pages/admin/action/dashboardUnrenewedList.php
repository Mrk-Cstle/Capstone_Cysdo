...
$sql = "SELECT * FROM scholar WHERE scholar_status IS NULL AND full_name LIKE '%$searchQuery%' LIMIT $start, $recordsPerPage";
...
<?php
    ...
    $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM scholar WHERE scholar_status IS NULL AND full_name LIKE '%$searchQuery%'"));
