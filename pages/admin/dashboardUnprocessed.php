...
<body>
    <section id="content" class="home-section">
        <nav class="navbar navbar-light bg-light d-flex mt-5">
            <h3 class="scholarList ms-5">Unprocessed Renewal List</h3>
        ...
        <script>
            ...
            function addData() {
                ...
                xhttp.open("GET", "action/dashboardUnprocessedList.php", true);
                xhttp.send();
            }
            ...
            function refreshTable(searchQuery = "") {
                ...
                xhttp.open("GET", "action/dashboardUnprocessedList.php?page=" + currentPage + "&searchQuery=" + searchQuery, true);
                xhttp.send();
            }
            ...
            function loadPage(page) {
                ...
                xhttp.open("GET", "action/dashboardUnprocessedList.php?page=" + page + "&searchQuery=" + searchQuery, true);
                xhttp.send();
            }
