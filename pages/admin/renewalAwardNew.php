...
<body>
    <section id="content" class="home-section">
        ...
        <nav class="navbar navbar-light bg-light d-flex mt-5">
            <h3 class="cashAllowance ms-5">Cash Allowance For New Scholar</h3>
            <a class="btnSearch btn btn-outline-success mb-3" href="renewalAwardNewArchive.php">Archive</a>
        ...
        <script>
            ...
            function loadTableData(page) {
                ...
                xhr.open('GET', 'action/renewalAwardNewDb.php?page=' + page, true);
                xhr.send();
            }
            ...
            function searchTableData(searchValue, page) {
                ...
                xhr.open('GET', 'action/renewalAwardNewDb.php?search=' + searchValue + '&page=' + page, true);
                xhr.send();
            }
            ...
            function refreshList() {
                ...
                xhttp.open("GET", "action/renewalAwardNewDb.php", true);
                xhttp.send();
            }
