...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT *FROM scholar_archive WHERE scholar_id= '$scholarId'";
                ...
                <div class="portlet light profileBar-portlet">
                    ...
                    <div class="profile-nm">
                        <div>
                            ...
                            <h4>Remove Date : <?php echo $remove_date; ?></h4>
                            <h4>Type : <?php echo $type; ?></h4>
                        </div>
                    </div>
                    <div class="actionBtn">
                        <button type="button" id="approveBtn" class="btnApprove btn btn-success btn-sm" onclick="sendAction('<?php echo $scholar_id; ?>', 'restore')">Restore</button>
                        <button type="button" id="approveBtn" class="btnApprove btn btn-success btn-sm" onclick="sendAction('<?php echo $scholar_id; ?>', 'delete')">Delete</button>
    ...
    <script>
        function sendAction(applicantId, action) {
            ...
            $.ajax({
                ...
                url: 'action/scholarArchiveAction.php', // Replace 'process_action.php' with the server-side script that will handle the approval/decline
                data: {
                    id: applicantId,
                    action: action
                },
