            ...
            <div class="portlet light profileBar-portlet">
                ...
                <div class="profile-usertab">
                    ...
                    <div class="actionBtn">
                        ...
                        <button type="button" id="approveBtn" class="btnApprove btn btn-success btn-sm" onclick="sendAction('<?php echo $applicantId; ?>', 'approve')">Restore</button>
                        <button type="button" id="declineBtn" class="btnDecline btn btn-danger btn-sm" onclick="sendAction('<?php echo $applicantId; ?>', 'decline')">Delete</button>
    ...
    <script>
        function sendAction(applicantId, action) {
            ...
            $.ajax({
                ...
                url: 'action/applicantViewArchiveDb.php', // Replace 'process_action.php' with the server-side script that will handle the approval/decline
                data: {
                    id: applicantId,
                    action: action
                },
                success: function(response) {
                    ...
                    if (action === 'approve') {
                        ...
                        $('#approveBtn').hide();
                        $('#declineBtn').hide();
                        window.location.href = 'applicantArchive.php';
