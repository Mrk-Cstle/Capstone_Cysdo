...
<body>
    ...
    <section id="content" class="home-section">
        ...
        <h3 class="newscholarsList">New Approved Scholar List</h3>
        ...
        <script>
            ...
            function loadTableData(page) {
                ...
                xhr.open('GET', 'action/applicantScholarDb.php?page=' + page, true);
                xhr.send();
            }
            ...
            function searchTableData(searchValue, page) {
                ...
                xhr.open('GET', 'action/applicantScholarDb.php?search=' + searchValue + '&page=' + page, true);
                xhr.send();
            }
