...
<head>
    ...
    <title>New Approved Scholar List</title>
    <style>
        .hidden-cell {
            display: none;
        }
...
<body>
    ...
    <section id="content" class="home-section">
        <nav class="navbar navbar-light bg-light d-flex mt-5">
            <h3 class="newscholarsList ms-5">New Scholar List</h3>
        ...
        <script>
            ...
            function loadTableData(page) {
                ...
                xhr.open('GET', 'action/reportNew.php?page=' + page, true);
                xhr.send();
            }
            ...
            function searchTableData(searchValue, page) {
                ...
                xhr.open('GET', 'action/reportNew.php?search=' + searchValue + '&page=' + page, true);
                xhr.send();
            }
            ...
            function refreshList() {
                ...
                xhr.open("GET", "action/reportNew.php?page=" + currentPage, true); // Pass the current page
                xhr.send();
            }
    ...
    function printTable() {
        ...
        printWindow.document.write('<h2>New Scholar List</h2> <style> h2 {text-align: center; margin-bottom: 20px;}</style>');
