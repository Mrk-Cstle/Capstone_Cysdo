...
if (isset($_FILES["imageUpdate"]) && $_FILES["imageUpdate"]["error"] == UPLOAD_ERR_OK) {
    ...
    $viewProfile = "SELECT * FROM scholar WHERE scholar_id = '$userId'";
    ...
    $targetDir = "../../../uploads/scholar/"; // Specify your target directory
    ...
    if (move_uploaded_file($_FILES["imageUpdate"]["tmp_name"], $targetFile)) {
        ...
        $sql = "UPDATE scholar SET image = ? WHERE scholar_id = ?";
