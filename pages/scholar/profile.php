                                        ...
                                        <div class="portlet-body form">
                                            <div class="row">
                                                ...
                                                $sql1 = "SELECT renewal.*, scholar.*
                                                        ...
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_1stYr_1stSem' ";
                                        ...
                                        <div class="portlet-body form">
                                            <div class="row">
                                                ...
                                                $sql2 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_1stYr_2ndSem' ";
                                ...
                                <div class="portlet-body form">
                                    <div class="row">
                                        ...
                                        $sql3 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_2ndYr_1stSem' ";
                                ...
                                <div class="portlet-body form">
                                    <div class="row">
                                        ...
                                        $sql4 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_2ndYr_2ndSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql5 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_3rdYr_1stSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql6 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_3rdYr_2ndSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql7 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_4thYr_1stSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql8 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_4thYr_2ndSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql9 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_5thYr_1stSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql10 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_5thYr_2ndSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql11 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_6thYr_1stSem' ";
                            ...
                            <div class="portlet-body form">
                                <div class="row">
                                    ...
                                    $sql12 = "SELECT renewal.*, scholar.*
                                                        FROM renewal
                                                        JOIN scholar ON scholar.scholar_id = renewal.scholar_id
                                                        WHERE scholar.scholar_id = '$id' AND renewal.semester = 'renew_6thYr_2ndSem' ";
